...
def music_transcription(myAudioFile):
    ...
    rate, data = scipy.io.wavfile.read(myAudioFile)
    #pdb.set_trace()
    ...
    central = AudioSegment.from_file("central.wav", format="wav") #cancel the lyrics noise!
